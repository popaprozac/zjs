// fetch / Request / Response / Headers — basic shape + data: URL.
//
// Live HTTP isn't probed here because that requires network access.
// fetch over data: URLs gives us a deterministic round-trip without
