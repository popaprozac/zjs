...
NIM_PARSEBIN := $(NIM_OUT)/nim-parse
nim-parse: $(NIM_PARSEBIN)
$(NIM_PARSEBIN): $(NIM_SRCS) nim/tools/nim_parse.nim nim/tools/labels.nim | $(NIM_OUT)
	$(NIM) c --mm:arc -d:release --hints:off --out:$(NIM_PARSEBIN) nim/tools/nim_parse.nim
